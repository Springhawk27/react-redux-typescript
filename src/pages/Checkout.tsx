...
export default function Checkout() {
  ...
  return (
    <div className="grid grid-cols-12 justify-center items-center h-[calc(100vh-80px)] md:gap-10 gap-4 text-primary sm:px-0 px-2">
      <div className="max-w-3xl w-full md:col-span-6 col-span-12">
      ...
      <div className="max-w-lg w-full md:col-span-6 col-span-12">
